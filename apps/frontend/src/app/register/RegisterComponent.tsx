        ...
        <div className="relative max-w-lg space-y-12">
          ...
          <div className="space-y-4">
            <h2 className="text-4xl font-bold tracking-tight text-white leading-tight">
              Twoja nowa przestrzeń do <span className="bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent">płynnej komunikacji</span> w zespole.
            </h2>
            <p className="text-base text-gray-400 leading-relaxed font-sans">
              Przełączaj się swobodnie między kanałami firmowymi a prywatnymi rozmowami ze znajomymi (DMs) bez żadnych ograniczeń. Wszystko w czasie rzeczywistym, bezpiecznie i z niesamowitym komfortem pracy.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-white text-sm">Kanały & Workspaces</h4>
                <p className="text-xs text-gray-400 mt-0.5">Zorganizowana komunikacja w dedykowanych przestrzeniach roboczych dla Twoich projektów.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-white text-sm">Globalne Wiadomości Bezpośrednie</h4>
                <p className="text-xs text-gray-400 mt-0.5">Rozmawiaj prywatnie ze znajomymi i współpracownikami bez barier i bez konieczności współdzielenia pokoi.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-white text-sm">Interaktywność Real-Time</h4>
                <p className="text-xs text-gray-400 mt-0.5">Szybkie reakcje emoji, statusy online w czasie rzeczywistym i błyskawiczne, stabilne dostarczanie wiadomości.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-20 bg-[#070b12] relative">
        ...
        <div className="w-full max-w-md space-y-8 z-10 font-sans">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">Stwórz konto</h2>
